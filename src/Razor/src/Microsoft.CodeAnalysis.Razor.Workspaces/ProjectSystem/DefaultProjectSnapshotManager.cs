...
namespace Microsoft.CodeAnalysis.Razor.ProjectSystem
{
    ...
    internal class DefaultProjectSnapshotManager : ProjectSnapshotManagerBase
    {
        ...
        public override void ProjectWorkspaceStateChanged(string projectFilePath, ProjectWorkspaceState workspaceProjectState)
        {
            if (projectFilePath == null)
            {
                throw new ArgumentNullException(nameof(projectFilePath));
            ...
            if (workspaceProjectState == null)
            {
                throw new ArgumentNullException(nameof(workspaceProjectState));
            }
            ...
            if (_projects.TryGetValue(projectFilePath, out var entry))
            {
                var state = entry.State.WithChangedTagHelpers(workspaceProjectState.TagHelpers);
